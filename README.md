...
- **sipeed/picoclaw** - [PR #211](https://github.com/sipeed/picoclaw/pull/211) _(Status: Open)_: security hardening (#179) and default model/CI fixes (#199), plus follow-up review fixes (shared private-file write helper, legacy-model edge-case test, and CI `go vet` + race test step). +348/-39 across 12 files.
