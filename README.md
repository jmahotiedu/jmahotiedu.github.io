...
- **sipeed/picoclaw** - [PR #211](https://github.com/sipeed/picoclaw/pull/211) _(Status: Open)_: security hardening (#179) and default model/CI fixes (#199), plus follow-up review fixes (shared private-file write helper, legacy-model edge-case test, CI `go vet` + race test step, and refreshed conflict resolution against upstream `main`). +282/-22 across 12 files.
